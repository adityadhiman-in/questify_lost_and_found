...
const FoundItems = () => {
  ...
  const { items, loading, error } = useItems('found');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-green-500 to-blue-500 text-white">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Found Items</h1>
          <p className="text-xl opacity-90">Items waiting to be reunited with their owners</p>
        </div>
      </section>
